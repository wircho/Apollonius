...
protocol FigureProtocolInternal: FigureProtocol, Simplifiable where Context == CanvasContext<S.T, Specifier> {
  associatedtype Specifier: CanvasSpecifierProtocol
  associatedtype S: GeometricShape where T == S.T
...
protocol UnstyledFigureProtocol: FigureProtocolInternal {}
